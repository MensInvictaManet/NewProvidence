...
enum MessageIDs
{
	...
	MESSAGE_ID_REQUEST_LATEST_UPLOADS			= 6,	// The list of the latest uploads on the server (server to client)
	...
	MESSAGE_ID_FILE_RECEIVE_READY				= 11,	// File Receive Ready (two-way)
	MESSAGE_ID_FILE_PORTION						= 12,	// File Portion Send (two-way)
	MESSAGE_ID_FILE_PORTION_COMPLETE			= 13,	// File Portion Complete Check (two-way)
	MESSAGE_ID_FILE_CHUNKS_REMAINING			= 14,	// File Chunks Remaining (two-way)
	MESSAGE_ID_FILE_PORTION_COMPLETE_CONFIRM	= 15,	// File Portion Complete Confirm (two-way)
};
