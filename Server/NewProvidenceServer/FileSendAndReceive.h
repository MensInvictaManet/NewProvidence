...
{
public:
	FileReceiveTask(std::string fileName, int fileSize, int fileChunkSize, int fileChunkBufferSize, std::string tempFilePath, int socketID, std::string ipAddress, const int port) :
		FileName(fileName),
		FileSize(fileSize),
